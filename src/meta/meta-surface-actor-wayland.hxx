...
MetaSurfaceActor * meta_surface_actor_wayland_new (wl::wl_surface *surface);
wl::wl_surface * meta_surface_actor_wayland_get_surface (MetaSurfaceActorWayland *self);
