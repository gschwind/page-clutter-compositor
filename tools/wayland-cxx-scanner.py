...
def gen_args_with_type(args, maptype, args_base):
...
def gen_request_args_with_type(args, args_base = None):
 return gen_args_with_type(args, map_type_request, args_base)

def gen_event_args_with_type(args, args_base = None):
 return gen_args_with_type(args, map_type_event, args_base)
